...
export default function RenameProject({ project, setProjects, onClose }) {
  const {
    register,
    handleSubmit,
    reset,
...
// const ProjectRename = ({ project, onUpdated, onClose }) => {
...
//       <div>
//         <label className="block mb-1">Project Color</label>
