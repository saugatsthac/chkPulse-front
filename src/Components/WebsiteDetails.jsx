...
import WeeklyUptimeChart from "./Dashboard/WeeklyTimeChart";
...
export default function WebsiteDetails({
    ...
    return (
        ...
        overflow-hidden">
            <div className="w-full h-full overflow-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-blue-900/10
               flex flex-col gap-7">
                {/* Header */}
