...
export default function AddProjectAndWebsites({ data }) {
  ...
  return (
    <div className="bg-[#111217] border border-white/10 rounded-2xl p-7 px-6 w-[420px] flex flex-col">
      <h1 className="text-lg font-light text-white/90">
        Add project and websites
      </h1>
      <div className="flex flex-col items-baseline gap-2 mt-3.5 border-b pb-7 border-white/10">
        ...
        {websites.map((website, index) => (
          <div className="flex gap-2 items-center">
            <input
              key={index}
              value={website}
              className="p-2 border border-white/15 rounded-lg grow"
